<template>
  <div>
    ...
    <MdAddTeacher v-if="isShowAdd" v-model:isShow="isShowAdd"></MdAddTeacher>
...
import MdProgramFrame from "./MdProgramFrame.vue";
import MdTimeFree from "../../components/MdTimeFree.vue";
import MdAddTeacher from "./MdAddTeacher.vue";
const { t } = window.i18n();
